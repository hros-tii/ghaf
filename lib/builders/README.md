...
- `vmConfig`: Attrs - VM hypervisor selection, resource allocation, and modules (default: {})
...
### Using vmConfig for Hypervisor and Resource Configuration

The `vmConfig` parameter selects a default system-VM hypervisor and supports
per-VM hypervisor and resource overrides. The default hypervisor is QEMU, while
...
- `vmConfig` for hypervisor selection and resource allocation (replaces
